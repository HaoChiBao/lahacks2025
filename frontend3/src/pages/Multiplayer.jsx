          ...
          {!gameModeSelect ? (
            ...
            <Card className="bg-white shadow-md rounded-2xl">
              <CardHeader>
                ...
                <CardDescription className="text-gray-500">Choose how you want to play</CardDescription>
              </CardHeader>
              <CardContent className="flex flex-col gap-6">
                <Button onClick={() => handleModeSelect("spot")} size="lg" className="w-full bg-gray-100 text-gray-800 hover:bg-blue-500 hover:text-white rounded-xl">
                  Spot the Difference
                </Button>
                <Button onClick={() => handleModeSelect("fill")} size="lg" variant="ghost" className="w-full hover:bg-blue-100 rounded-xl">
                  Fill in the Blanks
                </Button>
              </CardContent>
            </Card>
